...
def recommend(tags, minutes, age_bracket):
    ...
    def ok_age(item_age):
        ...
        return True
    def score(it):
        if not ok_age(it.get("age_range","13-18")): return -1e9
        if minutes is not None and it.get("minutes", 10) > minutes: return -1e9
...
if st.session_state.phase == "welcome":
    ...
    moods = ["Happy","Angry","Sad","Anxious","Confident","Stressed","Tired","Bored","Excited","Lonely","Overwhelmed","Worry"]
    ...
    opts = [("🫁 Breath Work","Breath Work","tech-breath"),
